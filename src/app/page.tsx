    ...
    <div className="bg-slate-50">
      ...
      <section className="bg-slate-100 py-24">
        ...
        >
          ...
          >
            <h2
              className={`order-1 mt-2 text-balance text-center text-5xl font-bold leading-tight tracking-tight text-gray-900 md:text-6xl`}
            >
              What our{' '}
              <span className="relative px-2">
                customers{' '}
                <Icons.underline
                  className={`pointer-events-none absolute inset-x-0 -bottom-6 hidden text-green-500 sm:block`}
                />
              </span>
              say
            </h2>
          ...
          <div
            className={`mx-auto grid max-w-2xl grid-cols-1 gap-y-16 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2`}
          >
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  <span className="bg-green-600 p-0.5 text-white">
              ...
              <div className="mt-2 flex gap-4">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Vladyslav</p>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div
              className={`relative flex grid-cols-2 flex-col items-center gap-40 md:grid`}
            >
              <Image
                src="/arrow.png"
              ...
              <div
                className={`relative h-80 w-full max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 md:h-full md:justify-self-end lg:rounded-2xl`}
              >
                <Image
                  src="/horse.jpg"
